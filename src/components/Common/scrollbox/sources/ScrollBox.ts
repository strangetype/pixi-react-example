...
export class ScrollBox extends Container {
     ...
     */
    constructor (options = {}, scrollBarDrawer = new DefaultScrollBarDrawer()) {
        super();
        this.options = Object.assign({}, scrollboxOptions, options);
        if (options.overflow) {
            this.options.overflowX = this.options.overflowY = options.overflow;
        }
        this.ease = typeof this.options.fadeScrollboxEase === 'function' ? this.options.fadeScrollboxEase : e => e;
         ...
         * @type {PIXI.Graphics}
         */
        this.scrollbar = this.addChild(scrollBarDrawer);
    ...
    _drawScrollbars () {
        ...
        if (this.isScrollbarVertical) {
            this.scrollbar
                ...
                .draw(this.boxWidth - this.scrollbarSize + this.options.scrollbarOffsetVertical, 0, this.scrollbarSize, this.boxHeight)
                .endFill();
        }
        if (this.isScrollbarHorizontal) {
            this.scrollbar
                .beginFill(this.options.scrollbarBackground, this.options.scrollbarBackgroundAlpha)
                .draw(0, this.boxHeight - this.scrollbarSize + this.options.scrollbarOffsetHorizontal, this.boxWidth, this.scrollbarSize)
                .endFill();
        }
        if (this.isScrollbarVertical) {
            this.scrollbar
                .beginFill(this.options.scrollbarForeground, this.options.scrollbarForegroundAlpha)
                .draw(this.boxWidth - this.scrollbarSize + this.options.scrollbarOffsetVertical, this.scrollbarTop, this.scrollbarSize, this.scrollbarHeight, true)
                .endFill();
        }
        if (this.isScrollbarHorizontal) {
            this.scrollbar
                .beginFill(this.options.scrollbarForeground, this.options.scrollbarForegroundAlpha)
                .draw(this.scrollbarLeft, this.boxHeight - this.scrollbarSize + this.options.scrollbarOffsetHorizontal, this.scrollbarWidth, this.scrollbarSize, true)
                .endFill();
        }
    ...
    updateLoop (elapsed) {
        if (this.fade) {
            ...
            if (this.fade.duration >= this.options.fadeScrollbarTime) {
                ...
                this.scrollbar.alpha = this.ease(1 - this.fade.duration / this.options.fadeScrollbarTime);
    ...
    scrollbarMove (e) {
        if (this.pointerDown) {
            if (this.pointerDown.type === 'horizontal') {
                ...
                const local = this.toLocal(e.data.global);
                const top = (this.boxHeight - this.scrollbarHeight) / this.boxHeight * (local.y - this.pointerDown.last.y);
