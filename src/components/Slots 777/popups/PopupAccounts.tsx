...
export const PopupAccountsComponent = (props) => {
    const {
        ...
        buttonOne: {
            text: textButtonOne = '',
            resource: resourceButtonOne = 'btn2_ok',
            slot: slotButtonOne = 'btn2'
        } = {},
        scroll: { title: titleScroll = '' } = {}
    } = props;
                          ...
                          <ContainerW
                              ...
                              props={{
                                  [PORTRAIT]: {
                                      ...
                                      y:
                              index * ACC_POPUP_ITEM_HEIGHT[applyOrientation()]
                                  },
                                  [LANDSCAPE]: {
                                      x:
                              index % 2
                                  ? ACC_POPUP_ITEM_OFFSET[applyOrientation()] +
                                  ACC_POPUP_WIDTH[applyOrientation()] / 2
                                  : ACC_POPUP_ITEM_OFFSET[applyOrientation()],
                                      y:
                              Math.floor(index / 2) *
                              ACC_POPUP_ITEM_HEIGHT[applyOrientation()]
                                  }
                              }}
                              scale={0.9}
                          >
                              {isShowText && <SpineW
                                  ...
                                  animations={[
                                      ...
                                      {
                                          name:
                                activeIdAccount === item.id ? 'loop2' : 'loop1',
                                          loop: true,
