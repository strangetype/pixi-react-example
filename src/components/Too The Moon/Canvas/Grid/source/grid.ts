...
export class Grid extends Graphics {
    ...
    set cellSize (cellSize = null) {
        this._cellSize = 50; // cellSize || Math.sqrt(this._correctedWidth);
    }
